...
public abstract class BaseCommunicationServiceEswShipment<T> {
    private static final Logger LOGGER = LoggerFactory.getLogger(BaseCommunicationServiceEswShipment.class);

    protected RestOperations restTemplate = new RestTemplate();

    @Autowired
    protected AuthServiceEswShipment authService;
